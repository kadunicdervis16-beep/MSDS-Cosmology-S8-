...
**Status:** **Paper LIV Published** | [Zenodo Portfolio](https://zenodo.org/search?q=metadata.creators.person_or_org.name%3A%22Kadunic%2C%20Dervis%22) | **DOI: 10.5281/zenodo.19338059**
...
* **Paper LIV (The Birefringence Fingerprint):** Formulated the **"Snowflake" Effect** (Particle-Specific Phase Coupling). Derived the 0.31° cosmic birefringence rotation as a new positive prediction for the **LiteBIRD 2030** mission.
...
3. **LiteBIRD (2030):** Must measure a cosmic polarization rotation angle $\beta > 0.1^\circ$. If $\beta \approx 0$, the MSDS torsional coupling model is dead.
